...
describe('Kawkah Parser', () => {
  ...
  it('should parse with custom options forcing value to an array.', () => {
    const expected = { _: ['arg1'], __: [], tags: ['tag1'] };
